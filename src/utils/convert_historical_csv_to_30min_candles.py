...
def main():
    converted_file_path = 'data/month_debug/EURUSD_30min.csv'
    candle = {}
    candles_tick_list = []
    minutes = 0
            ...
            if lines_count == 0:
                ...
                if (len(candles_tick_list) != 0):
                    ...
                    if ((first_candle_minutes < 30 and minutes >= 30) or (first_candle_minutes >= 30 and minutes < 30) or first_candle_hours != hours or first_candle_day != day):
                        ...
                        file1.write(
                            f'EURUSD, 30min, {candle["start_timestamp"]}, {candle["start_formatted_date"]}, {candle["open"]}, {candle["high"]}, {candle["low"]}, {candle["close"]}' + '\n')
                        file1.close()
                        candles_tick_list = []
