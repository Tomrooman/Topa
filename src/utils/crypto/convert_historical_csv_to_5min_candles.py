...
def main():
    converted_file_path = 'data/BTCUSD_5min.csv'
    candle = {}
    candles_tick_list = []
    minutes = 0
                ...
                if line_count == 0:
                    ...
                    if (len(candles_tick_list) != 0):
                        ...
                        if ((first_candle_minutes_character < 5 and current_minute_last_character >= 5) or (first_candle_minutes_character >= 5 and current_minute_last_character < 5) or first_candle_hours != hours or first_candle_day != day):
                            ...
                            file1.write(
                                f'BTCUSD, 5min, {candle["start_timestamp"]}, {candle["start_formatted_date"]}, {candle["open"]}, {candle["high"]}, {candle["low"]}, {candle["close"]}' + '\n')
                            file1.close()
                            candles_tick_list = []
