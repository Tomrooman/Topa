...
def main():
    converted_file_path = 'data/BTCUSD_1h.csv'
    candle = {}
    candles_tick_list = []
    minutes = 0
            ...
            for row in csv_file:
                ...
                if lines_count == 0:
                    ...
                    if (len(candles_tick_list) != 0):
                        ...
                        if (first_candle_hours != hours or first_candle_day != day):
                            candle = {
                            ...
                            file1.write(
                                f'BTCUSD, 1h, {candle["start_timestamp"]}, {candle["start_formatted_date"]}, {candle["open"]}, {candle["high"]}, {candle["low"]}, {candle["close"]}' + '\n')
                            file1.close()
                            candles_tick_list = []
